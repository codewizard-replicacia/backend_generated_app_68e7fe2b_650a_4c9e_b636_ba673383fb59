...
public class ShoppingCart {
  ...
  private Double amount;
	...
	@JoinColumn(name = "\"ShoppingCartUser\"", referencedColumnName = "\"UserId\"", insertable = false, updatable = false)
	private UserProfile user;
	
	@Column(name = "\"ShoppingCartUser\"")
	private Integer shoppingCartUser;
